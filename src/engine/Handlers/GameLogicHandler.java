...
public class GameLogicHandler {
    ...
    public static Vector2 ScreenPositionToWorld(Vector2 PositionScreen){
        return AddPosition(PositionScreen, PositionStartRender);
    }
    ...
    private static Vector2 AddPosition(Vector2 Position1, Vector2 Position2){
        return new Vector2(
