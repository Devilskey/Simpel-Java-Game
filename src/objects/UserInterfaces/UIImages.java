...
public class UIImages {
    ...
    public UIImages(String name, int width, int height, int positionX, int positionY, int positionZ, String contentPath, String borderStyle, String borderColor, int borderThickness, boolean isButton) {
        this.name = name;
        this.width = width;
        this.height = height;
